...
// PROTOKOL ANTI-BFCACHE (MENCEGAH BACK BUTTON MEMBUKA HISTORI DARI RAM)
...
async function initializeSystem() {
    try {
        ...
        // =========================================================================
        // PERBAIKAN: FUNGSI BUMI HANGUS DOM ABSOLUT
        // =========================================================================
        async function executeDeepWipe() {
            if (isBurned) return;
            isBurned = true;
            
            // 1. Nuke DOM Obrolan agar hilang dari RAM
            if (chatStream) chatStream.innerHTML = "";
            const inputArea = document.querySelector('.input-area');
            if (inputArea) inputArea.remove();

            // 2. Tampilkan Layar Hitam
