...
async function initializeSystem() {
    try {
        ...
        // FASE 3: Perombakan Arsitektur Bubble Chat (Warna, Ukuran Teks, Auto-Fold Media)
        function renderMessage(msgId, data) {
            ...
            if (data.media) {
                if (data.type === "AUDIO") {
                    ...
                    // Fitur Auto-Fold / Katalog Gambar
                    ...
                    // Logika menutup otomatis setelah gambar dimuat (5 detik)
                    setTimeout(() => {
                        const box = document.getElementById(containerId);
                        if (box) {
                            box.classList.add('is-folded');
                            box.style.maxHeight = '150px'; // Tinggi saat dilipat
                        }
                    }, 5000);
                }
            }
