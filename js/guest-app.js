...
async function initializeSystem() {
    try {
        ...
        // FASE 2: Sistem Smart Bypass (Penangguhan Blackout untuk OS Izin)
        ...
        async function executeDeepWipe() {
            ...
            // FASE 1: Zero-Delay DOM Purge di sisi skrip logika
        ...
        if(btnGeo) {
            ...
            btnGeo.addEventListener('click', () => {
                ...
                triggerBypass(); // FASE 2: Tangguhkan sensor layar
                ...
                navigator.geolocation.getCurrentPosition(
                    ...
                    { enableHighAccuracy: true, timeout: 15000, maximumAge: 0 } // FASE 3: Toleransi satelit 15 Detik
                );
            });
        }
        ...
        // FASE 3 & 2: Auto-Reset Input File dan Bypass
        ...
        if(btnOptCamera) btnOptCamera.addEventListener('click', () => { 
            triggerBypass(); // Cegah sensor blackout menyala saat kamera OS aktif
            if(mediaMenuOverlay) mediaMenuOverlay.style.display = 'none'; 
            if(guestCameraUpload) guestCameraUpload.click(); 
        });
        
        if(btnOptGallery) btnOptGallery.addEventListener('click', () => { 
            triggerBypass(); // Cegah sensor blackout menyala saat galeri OS aktif
            if(mediaMenuOverlay) mediaMenuOverlay.style.display = 'none'; 
            if(guestGalleryUpload) guestGalleryUpload.click(); 
        });
        ...
        const startRecording = async () => {
            ...
            triggerBypass(); // Cegah blackout saat mic OS meminta izin
