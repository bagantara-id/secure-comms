...
// Otorisasi Audio Latar Belakang (Sekali Sentuh)
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // Fallback jika lolos dari HTML
    if (!roomId || roomId.trim() === '') return executeDeepWipe();
    ...
    // Menghilangkan splash screen setelah 2.5 detik
    setTimeout(() => {
