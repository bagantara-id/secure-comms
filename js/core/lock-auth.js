...
export class LockAuthenticator {
    ...
    async validateAndLock(roomId) {
        ...
        try {
            // Jika waktu server kedaluwarsa, Firebase Rules akan memblokir perintah getDoc ini.
            // Memanipulasi jam lokal di HP target tidak akan berfungsi lagi.
            ...
            // Semua pelanggaran (waktu habis, sesi dihapus, akses ditolak) akan memicu tendangan ini
            return this.triggerPhantomRedirect();
        }
    }
